...
parser.add_argument('--mask_bulr', type=int,
                    default=None,
                    help='Mask blur')

parser.add_argument('--inpainting_fill', type=int,
                    default=None,
                    help='inpainting fill')

parser.add_argument('--inpaint_full_res', type=bool,
                    default=None,
                    help='inpaint full res padding')

parser.add_argument('--inpaint_full_res_padding', type=int,
                    default=None,
                    help='inpaint full res padding')

parser.add_argument('--inpainting_mask_invert', type=int,
                    default=None,
